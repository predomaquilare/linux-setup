...
# Ferramentas: tmux, ranger, vim 9.2, htop, zsh+oh-my-zsh, fonts-powerline,
#              latex, pdfpc, multimedia, zathura, vimiv, ag, fzf,
#              tmuxinator, angry-ip-scanner, ROS 2 Humble,
#              YouCompleteMe, GitHub Copilot, swaybg
# Tema: Eva-01 x Gundam (roxo/verde neon/preto)
# =============================================================================
...
# =============================================================================
info "Instalando dependencias para compilar Vim 9.1+..."
...
info "Compilando Vim 9.2 do fonte..."
cd /tmp
rm -rf vim
...
cd "$HOME"
info "Vim $(vim --version | head -1) instalado com sucesso"
...
echo "    ~/.vimrc  (eva01 + YCM + Copilot)"
echo "    ~/.oh-my-zsh/custom/themes/eva01.zsh-theme"
echo "    ~/.vim/colors/eva01gundam.vim"
echo "    ~/.clangd"
echo ""
echo "  Proximos passos:"
echo "  1. Abra um novo terminal (exec zsh)"
echo "  2. ros2 --version"
echo "  3. vim +PlugInstall +qall"
echo "  4. No vim: :Copilot setup  (autenticar GitHub)"
echo "  5. cd ~/.vim/plugged/YouCompleteMe && python3.12 install.py --clangd-completer"
echo "  6. ipscan  (Angry IP Scanner)"
echo ""